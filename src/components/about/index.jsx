  ...
  return (
    <AboutBodyStyled>
      <AboutTextStyle>
        ...
        <h3>
          Como membro da Hut8 Ej, empresa júnior de computação da universidade,
          pude aplicar na prática os conhecimentos adquiridos em sala de aula.
          Trabalhei em projetos desafiadores e colaborativos, contribuindo para
          soluções inovadoras.
        </h3>
        <h3>
          Agora, estou pronto para levar minha paixão pela programação e
          resolução de problemas para a sua equipe. Com habilidades aprimoradas
          e uma abordagem rápida e eficaz, estou entusiasmado para enfrentar
          novos desafios e contribuir para o sucesso...
        </h3>
      </AboutTextStyle>
      <AboutPicture>
